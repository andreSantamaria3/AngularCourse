...
@Component({
    ...
    templateUrl:'./post-Contrato.component.html',
    styleUrls:['./post-Contrato.component.css']
})
export class CedulaSearchComponent implements OnInit {
...
constructor (public router:Router,public postService: PostService,public postServiceContrat: PostServiceContrato, public postEmpleado: PostServicePerm, public route:ActivatedRoute){
     ...
     ResultadoBusqueda(CedulaInit:Postwo){
      ...
      // this.postService.elementoBusqueda(CedulaInit);
        ...
        if(this.EmpleadoPasar!=undefined){
          ...
          this.postServiceContrat.postSearch.Empleado_idEmpleado.Cedula=this.EmpleadoPasar.Cedula;
          this.postService.postPasar=this.EmpleadoPasar;
          console.log("router a crearpermisos");
          this.router.navigateByUrl("empleado/contratolist");
