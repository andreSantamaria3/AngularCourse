...
@Component({
    selector:'app-tmeasist-list',
    templateUrl:'./asist-tmelist.component.html',
    styleUrls:['./asist-tmelist.component.css'],
    encapsulation: ViewEncapsulation.None

})
export class AsistTMEListComponent implements OnInit{
  ...
  isLoading=false;
   posts :Asistencia[]=[
    ...
    private PostsSub: Subscription;
     //table data
     displayedColumns: string[] = ['id_Empleado','Nombre_Empleado', 'Apellido_Empleado', 'Movilidad_Permitida', 'Total'];
    ...
    ngOnInit(){
      ...
      if(this.postsService.PostMode==9){
...
export(){
  ...
  this.matTableExporter.exportTable('xlsx',{fileName:'ResumenTME'});
